...
const copy = {
  tr: {
    ...
    success: 'Doğrulama bağlantısı e-posta adresinize gönderildi. E-postanızı doğruladığınızda katalog otomatik gönderilecek.',
  ...
  en: {
    ...
    success: 'A verification link has been sent to your email. The catalog will be delivered automatically after verification.',
