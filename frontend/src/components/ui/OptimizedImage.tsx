...
const BLUR_DATA_URL =
  'data:image/svg+xml;charset=utf-8,%3Csvg xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22 viewBox%3D%220 0 1 1%22%3E%3Crect fill%3D%22%230a1018%22 width%3D%221%22 height%3D%221%22%2F%3E%3C%2Fsvg%3E';
...
const errorFallback = (className?: string, alt?: string) => (
  <div
    className={cn('flex items-center justify-center bg-(--color-bg-panel) text-(--color-text-muted)', className)}
    role="img"
    aria-label={alt}
  >
...
export function OptimizedImage({
  ...
  if (error) return errorFallback(fallbackClassName ?? className, alt);
