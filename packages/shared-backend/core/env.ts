...
export const env = {
  ...
  // Optional commerce/payment modules
  DEALER_CATALOG_ITEM_TYPES: parseEnvList(process.env.DEALER_CATALOG_ITEM_TYPES).length
    ...
    : ['product'],
  DEALER_ORDER_QUANTITY_UNIT: process.env.DEALER_ORDER_QUANTITY_UNIT || 'adet',
  ...
  HALKODE_APP_ID: process.env.HALKODE_APP_ID || '',
  HALKODE_APP_SECRET: process.env.HALKODE_APP_SECRET || '',
  HALKODE_MERCHANT_KEY: process.env.HALKODE_MERCHANT_KEY || '',
  HALKODE_POS_ID: parseEnvInt(process.env.HALKODE_POS_ID, 0),
  HALKODE_API_BASE: process.env.HALKODE_API_BASE || '',
} as const;
