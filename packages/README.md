...
Bu dizin, Ensotek projelerinin paylasimli kodlarini icerir. Bereketfide ve VistaSeed backend'lerinde **20 modul neredeyse birebir ayni** — bu paketler kod tekrarini %60-70 oraninda azaltir.
...
import { authPlugin } from '@ensotek/shared-backend/plugins';
import { galleryModule } from '@ensotek/shared-backend/modules/gallery';
import { getAuthUserId, handleRouteError } from '@ensotek/shared-backend/utils';
import type { EcosystemProduct } from '@ensotek/shared-types';
```
